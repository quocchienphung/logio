...
> **Current build:** the site UI now ships a black / grey / white monochrome system; third-party brand logos keep their official colours.
> The hues below document the reference; the live mapping is in `src/styles/stripe/mono.css` and
> `docs/research/MONOCHROME_SYSTEM.md`.
