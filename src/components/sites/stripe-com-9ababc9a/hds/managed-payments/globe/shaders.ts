// GLSL for the globe, verbatim from reference chunk 38639 (module ids noted). three.js prepends its
// own precision/uniform header (modelMatrix, projectionMatrix, position, normal, ...).

/** Dots vertex (67381): sphere dots, corona lift-off, screen-space gradient coordinate, depth facing. */
...
/** Dots fragment (41669): round sprite, 3-stop gradient, corona fade/whitening, back-face depth fade. */
...
/** Surface vertex (99001): camera-space gradient coordinate + fresnel. */
...
/** Atmosphere vertex (79930): camera-facing plane. */
...
/** Atmosphere fragment (47780): ring between the inner and outer radius with a soft outer fade. */
...
/** Glow vertex (33784): unit plane scaled to the camera frustum, uv spans the whole viewport. */
...
/** Glow fragment (22740): radial blob (CSS-style centre/radius), colour A->B, (1-d)^1.4 falloff. */
