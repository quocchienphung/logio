<button type="button" className="modular-solutions-bento-card modular-solutions-bento__card-connect" data-bento-card-hover-class="modular-solutions-bento__card-connect--hover" data-bento-card-root="true" aria-labelledby="bento-card-title-connect" aria-expanded="false" aria-haspopup="dialog" style={{"--card-shift-x": "-5.475555555555555px", "--card-shift-y": "-2px", "--card-grow-x": "5.475555555555555px", "--card-grow-y": "2px"}}>
  ...
  <div className="modular-solutions-bento-card__text">
    <h3 className="hds-heading modular-solutions-bento-card__title hds-heading--md" id="bento-card-title-connect">
  ...
  <div className="modular-solutions-bento-card__inner">
    <div className="modular-solutions-bento-card__content">
      <div className="modular-solutions-bento-card__content-inner">
        <div className="modular-solutions-bento-card__graphic">
          <div className="lazy-animation lazy-animation--loaded lazy-bento-graphic">
            <div className="connect-platform-dom-graphic-wrapper">
              <div className="dom-graphic dom-graphic--variant-default connect-platform-dom-graphic" data-status="ready" role="img" aria-label="Dashboard showing connected accounts with details including country, payment balance, and volume. This is overlaid with an order summary for showing a discount and a final price." style={{"--graphic-source-width": "1000px", "--graphic-source-height": "457px", "--graphic-aspect-ratio": "1000 / 457", "--graphic-scale": "1", "--graphic-max-width": "1000px"}}>
                <div className="dom-graphic__content dom-graphic__content--horizontal-scale-left" aria-hidden="true">
                  <div className="connect-platform-graphic">
                    <div className="connect-platform-graphic__payment-card">
                      <div className="connect-platform-graphic__payment-card-content connect-platform-graphic__payment-card-content--jackson-hot-yoga" style={{transform: "translateX(-200%)"}}>
                        <div className="connect-platform-graphic__payment-card-header">
                          <div className="connect-platform-graphic__payment-card-logo">
                            <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect width="29" height="29" rx="14.5" fill="#FF6118" />
                              <path d="M11.3426 19.7818V18.1737C11.8222 18.2583 12.0338 18.2866 12.471 18.2866C13.5572 18.2866 14.1073 17.9057 14.1073 16.7772V9.66777H15.9129V16.9183C15.9129 18.9354 14.7421 19.8946 12.6826 19.8946C12.1889 19.8946 11.8222 19.8664 11.3426 19.7818Z" fill="white" />
                            </svg>
                          </div>
                        ...
                        <div className="connect-platform-graphic__payment-screen connect-platform-graphic__payment-screen--order-details" style={{opacity: "1", transform: "translateY(0px)"}}>
                            ...
                            <div className="connect-platform-graphic__payment-method connect-platform-graphic__payment-method--active-jackson-hot-yoga">
                              <div className="connect-platform-graphic__payment-method-input">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <circle cx="6.7652" cy="6.7652" r="6.2652" stroke="#FF6118" />
                                  <circle cx="6.76483" cy="6.76483" r="2.25507" fill="#FF6118" />
                                </svg>
                                <div>
                                  {"Card"}
                                </div>
                              ...
                              <svg width="20" height="14" viewBox="0 0 20 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 2.31512C0 1.03652 1.03652 0 2.31512 0L17.3634 0C18.642 0 19.6785 1.03651 19.6785 2.31512L19.6785 11.5756C19.6785 12.8542 18.642 13.8907 17.3634 13.8907L2.31512 13.8907C1.03652 13.8907 0 12.8542 0 11.5756L0 2.31512Z" fill="#1A0826" />
                                <path fillRule="evenodd" clipRule="evenodd" d="M17.3464 6.52952C17.2404 5.66814 16.5638 5.14738 15.645 5.1504L12.5842 5.1504L13.055 8.98044H14.4325L14.3387 8.21443H15.7964C16.9422 8.21443 17.4675 7.49989 17.3464 6.52952ZM15.6465 7.14111L14.2054 7.14263L14.0919 6.22372L15.5405 6.22523C15.8811 6.22978 16.0552 6.42052 16.084 6.68393C16.1021 6.85197 16.0249 7.14111 15.6465 7.14111Z" fill="#FFFFFA" />
                                <path d="M7.44824 5.15039L7.91898 8.98043H12.5223L12.0514 5.15039L7.44824 5.15039Z" fill="#AA8FFF" />
                                <path d="M2.65426 7.91013L2.78595 8.98042H7.38461L7.23324 7.75571L5.08984 7.75571L5.07016 7.60282L7.04555 6.22371L6.91388 5.15039L2.31519 5.15039L2.46505 6.3766H4.61302L4.6327 6.5295L2.65426 7.91013Z" fill="#FFFFFA" />
                                <path d="M8.76124 3.68874C9.05482 3.96475 9.09511 4.39886 8.85119 4.65837C8.60727 4.91787 8.17148 4.90449 7.87791 4.62848C7.58433 4.35248 7.54404 3.91837 7.78796 3.65886C8.03188 3.39936 8.46766 3.41273 8.76124 3.68874Z" fill="#FFFFFA" />
                              </svg>
                            </div>
                            <div className="connect-platform-graphic__payment-method">
                              <div className="connect-platform-graphic__payment-method-input">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <circle cx="7.42334" cy="7.14679" r="6.20143" fill="white" stroke="#E7ECF1" strokeWidth="1.12753" />
                                </svg>
                                <div>
                                  {"Affirm"}
                                </div>
                        ...
                        <div className="connect-platform-graphic__payment-screen connect-platform-graphic__payment-screen--success" style={{opacity: "0"}}>
                          <div className="connect-platform-graphic__payment-screen-summary">
                            <div className="connect-platform-graphic__payment-screen-summary-label">
                              {"Thank you!"}
                            </div>
                            ...
                            <div className="connect-platform-graphic__payment-summary-table-row">
                              ...
                              <span className="connect-platform-graphic__payment-summary-table-row-value">
                                <svg width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M0 2.35294C0 1.05345 1.05345 0 2.35294 0H17.6471C18.9466 0 20 1.05345 20 2.35294V11.7647C20 13.0642 18.9466 14.1176 17.6471 14.1176H2.35294C1.05345 14.1176 0 13.0642 0 11.7647V2.35294Z" fill="#1A0826" />
                                  <path fillRule="evenodd" clipRule="evenodd" d="M17.6298 6.63603C17.5221 5.76058 16.8344 5.23132 15.9005 5.23439H12.7898L13.2682 9.12699H14.6683L14.5729 8.34847H16.0544C17.219 8.34847 17.7528 7.62225 17.6298 6.63603ZM15.9021 7.25762L14.4375 7.25916L14.3221 6.32524L15.7944 6.32678C16.1405 6.33139 16.3175 6.52525 16.3467 6.79296C16.3651 6.96375 16.2867 7.25762 15.9021 7.25762Z" fill="#FFFFFA" />
                                  <path d="M7.56982 5.23438L8.04825 9.12698H12.7267L12.2482 5.23438H7.56982Z" fill="#AA8FFF" />
                                  <path d="M2.69764 8.0392L2.83148 9.12697H7.50527L7.35142 7.88226H5.17301L5.15301 7.72686L7.16066 6.32523L7.02684 5.23438H2.35303L2.50534 6.48062H4.6884L4.7084 6.63602L2.69764 8.0392Z" fill="#FFFFFA" />
                                  <path d="M8.90426 3.74891C9.20263 4.02943 9.24358 4.47063 8.99567 4.73438C8.74777 4.99812 8.30487 4.98452 8.00649 4.70401C7.70812 4.42349 7.66717 3.98229 7.91508 3.71854C8.16298 3.4548 8.60588 3.46839 8.90426 3.74891Z" fill="#FFFFFA" />
                                </svg>
                              </span>
                            </div>
                            <div className="connect-platform-graphic__payment-summary-table-row">
                      ...
                      <div className="connect-platform-graphic__payment-card-content connect-platform-graphic__payment-card-content--quiet-fire-yoga" style={{transform: "translateX(-200%)"}}>
                        <div className="connect-platform-graphic__payment-card-header">
                          <div className="connect-platform-graphic__payment-card-logo">
                            <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <rect width="29" height="29" rx="14.5" fill="#E5EDF5" />
                              <path d="M18.9214 15.9752C18.6631 17.5536 17.5263 18.9808 16.0642 19.5977C14.9934 20.0496 13.8376 20.1511 12.6986 19.8833C12.4594 19.827 12.093 19.6432 11.879 19.6121C10.7186 19.1188 9.72456 18.1549 9.28761 16.9543C8.65501 15.2161 9.11423 13.6748 10.1933 12.2613C11.211 10.9282 13.0648 9.72856 12.9615 7.83839C12.9468 7.57019 12.8698 7.3957 12.8053 7.15015C12.7516 6.94577 12.7694 6.85941 13.0037 6.92175C13.4833 7.04938 14.1445 7.5043 14.5193 7.83222C15.8312 8.98024 16.5437 10.632 16.1461 12.3935L16.107 12.597C16.0989 12.6486 16.0815 12.6951 16.0927 12.7474C16.2476 12.6884 16.3948 12.5918 16.5199 12.4825C16.8162 12.2236 17.0469 11.7929 17.1748 11.4222C17.2393 11.2354 17.2758 10.9545 17.3564 10.7881C17.3894 10.7201 17.4586 10.6782 17.5346 10.7011C17.6019 10.7215 17.8831 11.1965 17.9345 11.2872C18.4153 12.1353 18.7716 13.0572 18.9243 14.0183C19.0273 14.6664 19.0241 15.3271 18.9214 15.9752Z" fill="#D8571B" />
                              <path d="M16.6633 14.496C16.6807 14.4934 16.6816 14.4909 16.6924 14.5048C16.736 14.5608 16.8201 14.7259 16.8554 14.7966C17.5546 16.1968 16.9983 18.3385 15.6653 19.1739C14.5828 19.8523 12.9015 19.7127 11.916 18.9096C10.8551 18.045 10.5794 16.4114 11.0904 15.17C11.5338 14.0929 12.2754 13.5008 12.9757 12.6398C13.548 11.9362 13.9266 11.1629 13.8872 10.2254C13.9119 10.2189 13.9157 10.2357 13.9299 10.2467C14.4451 10.6447 14.9166 11.6491 14.9553 12.2956C14.9836 12.7678 14.838 13.2629 14.8996 13.7132C14.9542 14.112 15.492 14.9553 15.93 14.9831C16.2022 15.0003 16.5382 14.7257 16.6633 14.496Z" fill="#F59223" />
                              <path d="M16.0502 19.6025C16.0794 19.6106 16.1103 19.6114 16.1344 19.6117C16.7552 19.6194 17.4645 19.5633 18.0711 19.611C18.3736 19.6347 18.4358 19.8915 18.345 20.1458C17.9549 21.2381 15.9047 21.7566 14.8817 21.8613C13.3956 22.0134 10.8288 21.7707 9.77135 20.5718C9.56492 20.3378 9.22264 19.7382 9.72175 19.6258L11.857 19.6114C11.8617 19.612 11.8666 19.6108 11.8713 19.6114C12.0853 19.6426 12.4517 19.8264 12.6909 19.8827C13.8298 20.1506 14.9795 20.0543 16.0502 19.6025Z" fill="#171A16" />
                              <path d="M13.6766 14.3221C13.6295 14.3752 13.5777 14.4312 13.5358 14.4819C13.0881 15.0233 12.4941 16.3743 12.3993 17.0775C12.27 18.0363 12.5343 19.1185 13.5221 19.4831C15.2795 20.1318 16.2485 17.7116 15.1947 16.4951L15.1526 16.4588C15.0972 16.4109 15.0425 16.362 14.9889 16.312C14.707 16.0493 14.3777 15.8256 14.1885 15.4873C13.9471 15.0554 13.9381 14.5588 13.9485 14.0744C13.9487 14.0673 13.9408 14.0629 13.935 14.0668C13.9209 14.0766 13.9099 14.0901 13.8986 14.1034C13.8783 14.1273 13.8667 14.1406 13.8481 14.1589L13.6766 14.3221Z" fill="#FCBC4C" />
                            </svg>
                          </div>
                          <div className="connect-platform-graphic__payment-card-merchant-name">
                            {"Quiet Fire Yoga"}
                          ...
                          <div className="connect-platform-graphic__payment-method-card">
                            ...
                            <div className="connect-platform-graphic__payment-method-payment-card">
                              ...
                              <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M2.13021 0.240071C2.34548 0.0247942 2.69452 0.0247942 2.90979 0.240071L6.05979 3.39007C6.27507 3.60535 6.27507 3.95438 6.05979 4.16966L2.90979 7.31966C2.69452 7.53493 2.34548 7.53493 2.13021 7.31966C1.91493 7.10438 1.91493 6.75535 2.13021 6.54007L4.89041 3.77986L2.13021 1.01966C1.91493 0.804379 1.91493 0.455347 2.13021 0.240071Z" fill="#171717" />
                              </svg>
                            </div>
                          </div>
                        ...
                        <div className="connect-platform-graphic__payment-screen connect-platform-graphic__payment-screen--success" style={{opacity: "0"}}>
                          ...
                          <div className="connect-platform-graphic__payment-summary-table">
                            ...
                            <div className="connect-platform-graphic__payment-summary-table-row">
                              ...
                              <span className="connect-platform-graphic__payment-summary-table-row-value">
                                <svg width="20" height="15" viewBox="0 0 20 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M0 2.35294C0 1.05412 1.05455 0 2.35364 0H17.6473C18.9473 0 20 1.05412 20 2.35294V11.7647C20 13.0635 18.9464 14.1176 17.6473 14.1176H2.35364C1.05364 14.1176 0 13.0635 0 11.7647V2.35294Z" fill="#00D66F" />
                                  <path d="M8.96549 2.35303H6.4707C6.95592 4.40891 8.37244 6.16567 10.1446 7.27126C8.36896 8.37597 6.95592 10.1327 6.4707 12.1886H8.96375C9.58114 10.2871 11.2924 8.6345 13.3942 8.29744V6.24156C11.2898 5.90626 9.57853 4.2545 8.96375 2.35303H8.96549Z" fill="#011E0F" />
                                </svg>
                              </span>
                            </div>
                            <div className="connect-platform-graphic__payment-summary-table-row">
                      ...
                      <div className="connect-platform-graphic__payment-card-content connect-platform-graphic__payment-card-content--daybreak-yoga" style={{transform: "translateX(-200%)"}}>
                        <div className="connect-platform-graphic__payment-card-header">
                          <div className="connect-platform-graphic__payment-card-logo">
                            <svg width="29" height="29" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <circle cx="14.3851" cy="14.4832" r="14.3851" fill="url(#connect-payment-card-graphic-daybreak-yoga-logo-gradient)" />
                              <path d="M15.2671 7.2588C15.249 7.64689 15.0676 8.24655 14.5792 8.24655C14.0908 8.24655 13.8913 7.64689 13.8913 7.2588C13.8913 6.87071 14.1041 6.27104 14.5792 6.27104C15.0543 6.27104 15.2502 6.87071 15.2671 7.2588C15.2961 7.88627 16.2754 7.8899 16.2464 7.2588C16.2029 6.32424 15.6359 5.29175 14.5792 5.29175C13.5225 5.29175 12.912 6.32303 12.912 7.2588C12.912 8.19457 13.5189 9.1799 14.5103 9.22101C15.5996 9.26574 16.2017 8.22479 16.2464 7.2588C16.2754 6.62891 15.2961 6.63012 15.2671 7.2588Z" fill="#D6D9FC" />
                              <path d="M14.6568 9.88012C12.911 9.88617 11.274 10.1812 10.2209 11.7263C9.47376 12.824 9.4387 14.2241 8.54404 15.236C7.86821 16.0013 6.94695 16.4861 5.97733 16.7654C5.37282 16.9395 5.63034 17.8849 6.23726 17.7096C7.13676 17.4497 7.98669 17.0374 8.70846 16.4365C9.74821 15.5721 10.1 14.4997 10.5377 13.275C10.8895 12.2885 11.5448 11.4192 12.5676 11.0831C13.2398 10.8618 13.9567 10.8606 14.658 10.8582C15.2879 10.8558 15.2891 9.87649 14.658 9.87891L14.6568 9.88012Z" fill="#D6D9FC" />
                              <path d="M12.4394 20.8057C11.3271 21.2893 10.0129 21.5348 8.80878 21.3002C8.25264 21.1914 7.67232 20.9448 7.53691 20.3427C7.24675 19.0527 8.60929 18.5461 9.75785 18.5255C10.3877 18.5135 10.3889 17.5342 9.75785 17.5463C8.65886 17.5668 7.4148 17.8558 6.81271 18.8749C6.51409 19.3803 6.45485 20.0368 6.59268 20.6038C7.22136 23.1947 11.2473 22.3859 12.9339 21.6532C13.5106 21.403 13.0125 20.5591 12.4394 20.8081V20.8057Z" fill="#D6D9FC" />
                              <path d="M9.75766 18.5255C11.3644 18.5533 13.0365 19.2775 14.2322 20.3547C14.6989 20.7755 15.394 20.0851 14.9249 19.662C13.5346 18.4095 11.6304 17.5789 9.75766 17.5462C9.12777 17.5354 9.12656 18.5146 9.75766 18.5255Z" fill="#D6D9FC" />
                              <path d="M11.5361 13.362C11.8251 14.2216 12.085 15.2964 11.8396 16.1947C11.6752 16.7956 11.1384 17.284 10.5895 17.5512C10.0406 17.8184 10.5194 18.6719 11.084 18.3963C11.8142 18.0396 12.4792 17.3638 12.7403 16.59C13.1078 15.5043 12.837 14.1575 12.4804 13.0996C12.2809 12.506 11.3342 12.7599 11.5361 13.3596V13.362Z" fill="#D6D9FC" />
                              <path d="M14.4958 10.8592C15.1958 10.8616 15.914 10.8616 16.5862 11.0841C17.6102 11.4226 18.2607 12.2882 18.6161 13.276C19.0574 14.5007 19.4044 15.5731 20.4453 16.4375C21.1671 17.0384 22.017 17.4507 22.9165 17.7106C23.5235 17.8859 23.7822 16.9405 23.1765 16.7664C22.2298 16.4931 21.3315 16.0265 20.6605 15.2926C19.7272 14.271 19.6958 12.848 18.9329 11.7273C17.8798 10.1809 16.2428 9.88715 14.497 9.88111C13.8672 9.87869 13.8659 10.858 14.497 10.8604L14.4958 10.8592Z" fill="#D6D9FC" />
                              <path d="M19.4168 17.5226C17.5441 17.5552 15.6399 18.387 14.2495 19.6383C14.0549 19.8136 14.067 20.1534 14.2495 20.3311C15.7293 21.7722 18.0567 22.5109 20.0866 22.2981C21.0574 22.1966 22.0935 21.8375 22.4865 20.8618C22.692 20.3516 22.7101 19.7036 22.5191 19.185C22.0536 17.9264 20.6258 17.5443 19.4156 17.5226C18.7857 17.5105 18.7857 18.4898 19.4156 18.5019C20.2728 18.5176 21.5265 18.8126 21.651 19.7205C21.7369 20.348 21.5035 20.8703 20.9003 21.1254C19.609 21.6707 17.8693 21.3055 16.6433 20.7421C16.0388 20.4641 15.421 20.1074 14.9411 19.6395V20.3323C16.1368 19.2551 17.8088 18.5309 19.4156 18.5031C20.0455 18.4922 20.0467 17.5129 19.4156 17.5238L19.4168 17.5226Z" fill="#D6D9FC" />
                              <path d="M16.7327 13.1021C16.3773 14.1599 16.1053 15.5056 16.4728 16.5925C16.7352 17.3662 17.3989 18.0421 18.1291 18.3987C18.6938 18.6744 19.1907 17.8293 18.6236 17.5536C18.0566 17.278 17.5404 16.798 17.3735 16.1971C17.1257 15.3012 17.388 14.2216 17.677 13.3644C17.8789 12.766 16.9334 12.5084 16.7327 13.1045V13.1021Z" fill="#D6D9FC" />
                              <defs>
                                <linearGradient id="connect-payment-card-graphic-daybreak-yoga-logo-gradient" x1="14.3851" y1="0.0981443" x2="21.7426" y2="38.5049" gradientUnits="userSpaceOnUse">
                                  <stop stopColor="#938DFF" />
                        ...
                        <div className="connect-platform-graphic__payment-screen connect-platform-graphic__payment-screen--order-details" style={{opacity: "1", transform: "translateY(0px)"}}>
                          ...
                          <div className="connect-platform-graphic__payment-card-order-data connect-platform-graphic__payment-card-order-data--pricing-type connect-platform-graphic__payment-card-dropdown-order-data">
                            <div className="connect-platform-graphic__payment-card-order-pricing-type">
                              ...
                              <svg width="8" height="7" viewBox="0 0 8 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path fillRule="evenodd" clipRule="evenodd" d="M6.46902 2.25726C6.6343 2.09198 6.90226 2.09198 7.06754 2.25726C7.23282 2.42253 7.23282 2.6905 7.06754 2.85578L4.40386 5.51946C4.23873 5.68458 3.97101 5.68458 3.80589 5.51946L1.14221 2.85578C0.97693 2.6905 0.97693 2.42253 1.14221 2.25726C1.30748 2.09198 1.57545 2.09198 1.74073 2.25726L4.10487 4.62141L6.46902 2.25726Z" fill="#0A2540" />
                              </svg>
                            </div>
                          ...
                          <div className="connect-platform-graphic__payment-method-list">
                            <div className="connect-platform-graphic__payment-method connect-platform-graphic__payment-method--active">
                              <div className="connect-platform-graphic__payment-method-input">
                                <svg width="15" height="14" viewBox="0 0 15 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <circle cx="7.42347" cy="7.15265" r="6.20143" fill="white" stroke="#6B59FE" strokeWidth="1.12753" />
                                  <circle cx="7.42328" cy="7.15204" r="2.25507" fill="#6B59FE" />
                                </svg>
                                <div>
                                  {"Card"}
                                </div>
                              ...
                              <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.617859 3.14471C0.617859 1.86611 1.65437 0.82959 2.93298 0.82959L17.9813 0.82959C19.2599 0.82959 20.2964 1.8661 20.2964 3.14471L20.2964 12.4052C20.2964 13.6838 19.2599 14.7203 17.9813 14.7203L2.93298 14.7203C1.65437 14.7203 0.617859 13.6838 0.617859 12.4052L0.617859 3.14471Z" fill="#1434CB" />
                                <path d="M10.1192 5.00681L8.98507 10.4541H7.60794L8.74204 5.00681L10.1192 5.00681ZM15.8302 8.52657L16.5593 6.47338L16.9643 8.52657L15.8302 8.52657ZM17.3694 10.4541H18.625L17.5314 5.00681H16.3568C16.1137 5.00681 15.8707 5.17442 15.7897 5.42583L13.7645 10.4541H15.1821L15.4657 9.65793L17.2073 9.65793L17.3694 10.4541ZM13.805 8.65228C13.805 7.22761 11.9013 7.14381 11.9013 6.51528C11.9418 6.22197 12.1849 6.05436 12.4684 6.05436C12.9139 6.01246 13.4 6.09626 13.805 6.30577L14.048 5.13252C13.643 4.96491 13.1975 4.8811 12.7924 4.8811C11.4558 4.8811 10.4837 5.63534 10.4837 6.68289C10.4837 7.47902 11.1723 7.89804 11.6583 8.14946C12.1849 8.40087 12.3874 8.56848 12.3469 8.81989C12.3469 9.197 11.9418 9.36461 11.5368 9.36461C11.0508 9.36461 10.5647 9.23891 10.1192 9.0294L9.87615 10.2027C10.3622 10.4122 10.8887 10.496 11.3748 10.496C12.8734 10.5379 13.805 9.78363 13.805 8.65228ZM8.17499 5.00681L5.98778 10.4541H4.52965L3.43605 6.09626C3.43605 5.88675 3.27403 5.71914 3.11202 5.63534C2.70698 5.42583 2.26144 5.25822 1.77539 5.17442L1.81589 5.00681H4.12461C4.44864 5.00681 4.69166 5.25822 4.73217 5.55153L5.29922 8.69418L6.75736 5.00681H8.17499Z" fill="white" />
                              </svg>
                            </div>
                            <div className="connect-platform-graphic__payment-method">
                              <div className="connect-platform-graphic__payment-method-input">
                              ...
                              <svg width="21" height="15" viewBox="0 0 21 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.632324 3.17743C0.632324 1.89882 1.66884 0.862305 2.94744 0.862305L17.9957 0.862305C19.2743 0.862305 20.3109 1.89882 20.3109 3.17743L20.3109 12.4379C20.3109 13.7165 19.2743 14.753 17.9957 14.753L2.94744 14.753C1.66884 14.753 0.632324 13.7165 0.632324 12.4379L0.632324 3.17743Z" fill="#FFB3C7" />
                                <path d="M14.9448 9.8186C14.4419 9.8186 14.0341 10.2261 14.0341 10.7288C14.0341 11.2314 14.4419 11.639 14.9448 11.639C15.4478 11.639 15.8556 11.2314 15.8556 10.7288C15.8556 10.2261 15.4478 9.8186 14.9448 9.8186Z" fill="#17120F" />
                                <path d="M12.9559 4.53296L11.3818 4.53296C11.3818 5.82235 10.7886 7.00581 9.75438 7.78007L9.13074 8.24683L11.5471 11.5398H13.5339L11.3105 8.50977C12.3644 7.46092 12.9559 6.04984 12.9559 4.53296Z" fill="#17120F" />
                                <path d="M7.32977 11.5396H8.93831L8.93831 4.53296H7.32977L7.32977 11.5396Z" fill="#17120F" />
                              </svg>
                            </div>
                          </div>
                    ...
                    <div className="connect-platform-graphic__dashboard-browser">
                      <div className="browser-graphic" style={{"--browser-graphic-desktop-width": "728px", "--browser-graphic-desktop-height": "464px", "--browser-graphic-mobile-width": "728px", "--browser-graphic-mobile-height": "464px"}}>
                        ...
                        <div className="browser-graphic__page">
                          <div className="connect-platform-graphic__dashboard">
                            <div className="connect-platform-graphic__dashboard-sidebar">
                              <span className="connect-platform-graphic__dashboard-sidebar-title">
                                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <rect x="0.83844" y="0.0786133" width="23.998" height="23.998" rx="11.999" fill="#FED5E9" />
                                  <path d="M14.6832 7.01403C14.5975 6.74385 14.4342 6.5019 14.2608 6.28112C13.9382 5.87081 13.4018 5.25586 12.8323 5.25586C12.2627 5.25586 11.7546 5.84561 11.436 6.23979C11.2495 6.47065 11.0721 6.72772 10.9813 7.01403C10.8221 7.51607 11.6104 7.7308 11.7687 7.23077C11.8675 6.91825 12.4673 6.11176 12.8323 6.11176C13.1972 6.11176 13.797 6.91825 13.8958 7.23077C14.0541 7.72979 14.8424 7.51708 14.6832 7.01403Z" fill="#CE0045" />
                                  <path d="M12.4937 15.2704C11.8778 13.5153 10.5087 11.8589 8.84633 11.0232C8.16988 10.6835 7.44705 10.4738 6.69499 10.3891C6.24336 10.3377 5.78768 10.3367 5.33504 10.378C4.88239 10.4193 4.32187 10.4254 3.95693 10.6895C2.93671 11.4295 4.40857 13.3459 4.97715 13.9659C6.35324 15.466 8.32311 15.6192 10.1448 14.8813C10.6257 14.6867 10.415 13.8964 9.92804 14.094C8.54389 14.6545 7.02667 14.7452 5.85724 13.6887C5.45601 13.3258 5.13442 12.8943 4.86828 12.4245C4.76041 12.234 4.66161 12.0384 4.57189 11.8388C4.45495 11.5767 4.31582 11.3579 4.69589 11.2853C7.24442 10.7994 9.55907 11.9194 10.9563 14.0546C11.1741 14.3873 11.3697 14.7351 11.54 15.095C11.6419 15.3108 11.6378 15.2906 11.7064 15.4862C11.8788 15.9791 12.6681 15.7664 12.4937 15.2694V15.2704Z" fill="#CE0045" />
                                  <rect x="12.4056" y="16.7036" width="0.856903" height="2.19581" rx="0.428451" fill="#CE0045" />
                                  <path d="M11.952 11.7765C12.074 10.5012 11.7403 9.1493 10.8794 8.17948C10.1989 7.4123 9.2079 6.96167 8.21187 6.77718C6.86905 6.52918 6.81663 8.38917 6.79748 9.31564C6.78639 9.84087 7.60297 9.84087 7.61406 9.31564C7.62414 8.82266 7.63522 8.2319 7.83584 7.77018C7.94371 7.52017 8.01428 7.5615 8.28244 7.62602C8.50221 7.67844 8.72098 7.74296 8.93167 7.82361C9.61316 8.08673 10.217 8.53938 10.6031 9.16543C11.081 9.93966 11.2211 10.8802 11.1354 11.7755C11.085 12.2987 11.9026 12.2946 11.952 11.7755V11.7765Z" fill="#CE0045" />
                                  <path d="M13.9576 15.4873C14.0685 15.1727 14.3034 14.713 14.5403 14.3209C15.0474 13.4821 15.7057 12.7119 16.5162 12.1524C17.6423 11.3751 18.97 11.0686 20.3279 11.1947C20.6041 11.2199 21.2554 11.1967 21.212 11.5485C21.1899 11.729 21.0437 11.9487 20.9651 12.108C20.7352 12.5687 20.458 13.0093 20.1092 13.3893C18.9155 14.6888 17.3015 14.7291 15.7359 14.095C15.249 13.8974 15.0373 14.6878 15.5192 14.8824C17.1574 15.5457 18.9307 15.5235 20.3128 14.3299C20.8048 13.9055 21.205 13.3672 21.5215 12.8016C21.7756 12.3469 22.2061 11.6534 22.0266 11.1201C21.7514 10.3035 20.3854 10.3478 19.6888 10.3488C18.8672 10.3488 18.0455 10.5011 17.2844 10.8136C16.0505 11.3207 15.0413 12.2068 14.259 13.2754C13.8155 13.8813 13.4213 14.5608 13.1713 15.2715C12.9969 15.7685 13.7852 15.9822 13.9586 15.4883L13.9576 15.4873Z" fill="#CE0045" />
                                  <path d="M18.4573 9.72509C18.9828 9.72509 18.9838 8.9082 18.4573 8.9082C17.9309 8.9082 17.9309 9.72509 18.4573 9.72509Z" fill="#CE0045" />
                                  <path d="M14.5276 11.7764C14.4419 10.8812 14.582 9.94057 15.0599 9.16633C15.4329 8.56146 16.0085 8.11889 16.6628 7.85174C16.8735 7.76605 17.0912 7.69952 17.311 7.64407C17.5681 7.57955 17.6931 7.49285 17.811 7.72069C18.0419 8.16628 18.0378 8.83164 18.0479 9.31654C18.059 9.84178 18.8756 9.84278 18.8645 9.31654C18.8454 8.38907 18.7929 6.52908 17.4501 6.77809C16.4531 6.96258 15.4661 7.41321 14.7826 8.18039C13.9207 9.14819 13.588 10.5031 13.71 11.7774C13.7594 12.2955 14.577 12.3006 14.5266 11.7774L14.5276 11.7764Z" fill="#CE0045" />
                                </svg>
                                {"Zenflow"}
                              </span>
                            </div>
                            <div className="connect-platform-graphic__dashboard-main">
                              ...
                              <div className="connect-platform-graphic__dashboard-table-row connect-platform-graphic__dashboard-table-row--daybreak-yoga" style={{opacity: "1"}}>
                                <div className="connect-platform-graphic__dashboard-table-row-bg" style={{opacity: "0"}}>
                                </div>
                                <div className="connect-platform-graphic__dashboard-table-account-column">
                                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="8" cy="8" r="8" fill="url(#connect-dashboard-graphic-daybreak-yoga-logo-gradient)" />
                                    <path d="M8.49043 3.98237C8.48035 4.19819 8.37949 4.53169 8.10786 4.53169C7.83622 4.53169 7.72528 4.19819 7.72528 3.98237C7.72528 3.76654 7.84362 3.43304 8.10786 3.43304C8.37209 3.43304 8.48102 3.76654 8.49043 3.98237C8.50657 4.33132 9.05118 4.33334 9.03505 3.98237C9.01084 3.46263 8.6955 2.88843 8.10786 2.88843C7.52021 2.88843 7.18066 3.46196 7.18066 3.98237C7.18066 4.50278 7.51819 5.05075 8.06953 5.07361C8.67533 5.09849 9.01017 4.51958 9.03505 3.98237C9.05118 3.63206 8.50657 3.63274 8.49043 3.98237Z" fill="#D6D9FC" />
                                    <path d="M8.15079 5.44013C7.1799 5.44349 6.26951 5.60755 5.68388 6.46683C5.26836 7.07734 5.24886 7.85593 4.75131 8.4187C4.37546 8.84431 3.86312 9.11393 3.32388 9.26924C2.9877 9.36607 3.13092 9.89185 3.46844 9.79436C3.96868 9.6498 4.44135 9.42053 4.84276 9.08636C5.42099 8.60562 5.61665 8.00923 5.86004 7.32813C6.0557 6.77948 6.42012 6.29605 6.98894 6.10913C7.36278 5.98609 7.76149 5.98542 8.15146 5.98407C8.50176 5.98273 8.50244 5.43811 8.15146 5.43946L8.15079 5.44013Z" fill="#D6D9FC" />
                                    <path d="M6.91776 11.5161C6.29918 11.7851 5.56833 11.9216 4.89865 11.7911C4.58936 11.7306 4.26663 11.5934 4.19132 11.2586C4.02995 10.5412 4.78771 10.2595 5.42646 10.248C5.77676 10.2413 5.77743 9.69671 5.42646 9.70343C4.81528 9.71486 4.12341 9.87556 3.78858 10.4424C3.6225 10.7234 3.58956 11.0885 3.66621 11.4038C4.01583 12.8447 6.25481 12.3949 7.19276 11.9875C7.51348 11.8483 7.23646 11.379 6.91776 11.5175V11.5161Z" fill="#D6D9FC" />
                                    <path d="M5.42606 10.248C6.31964 10.2635 7.24952 10.6662 7.91449 11.2653C8.17402 11.4993 8.56063 11.1154 8.29975 10.8801C7.52653 10.1835 6.46756 9.72157 5.42606 9.70342C5.07576 9.69737 5.07509 10.242 5.42606 10.248Z" fill="#D6D9FC" />
                                    <path d="M6.41509 7.37642C6.57579 7.85447 6.72035 8.4522 6.58386 8.95177C6.49242 9.28593 6.19389 9.55757 5.88863 9.70616C5.58338 9.85475 5.84964 10.3294 6.16363 10.1761C6.56974 9.9778 6.93954 9.60194 7.08477 9.17163C7.28917 8.56785 7.13856 7.81883 6.94021 7.23051C6.82927 6.90038 6.30281 7.04158 6.41509 7.37507V7.37642Z" fill="#D6D9FC" />
                                    <path d="M8.06113 5.98462C8.45043 5.98596 8.84982 5.98596 9.22365 6.10968C9.79315 6.29794 10.1549 6.77935 10.3526 7.32868C10.598 8.00978 10.7909 8.60617 11.3698 9.08691C11.7712 9.42108 12.2439 9.65035 12.7442 9.79491C13.0817 9.8924 13.2256 9.36661 12.8887 9.26979C12.3623 9.11784 11.8627 8.85831 11.4895 8.45018C10.9705 7.88203 10.953 7.09066 10.5287 6.46738C9.94308 5.60742 9.0327 5.44404 8.06181 5.44068C7.7115 5.43933 7.71083 5.98395 8.06181 5.98529L8.06113 5.98462Z" fill="#D6D9FC" />
                                    <path d="M10.7981 9.69025C9.75658 9.7084 8.69761 10.171 7.92439 10.8669C7.81614 10.9644 7.82286 11.1533 7.92439 11.2521C8.74736 12.0536 10.0417 12.4644 11.1706 12.3461C11.7105 12.2896 12.2867 12.0899 12.5052 11.5473C12.6195 11.2636 12.6296 10.9032 12.5234 10.6147C12.2645 9.91482 11.4704 9.70235 10.7974 9.69025C10.4471 9.68352 10.4471 10.2281 10.7974 10.2349C11.2741 10.2436 11.9714 10.4077 12.0406 10.9126C12.0883 11.2616 11.9586 11.552 11.6231 11.6939C10.905 11.9971 9.93745 11.7941 9.25567 11.4808C8.91949 11.3261 8.57591 11.1278 8.30898 10.8676V11.2528C8.97395 10.6537 9.90383 10.251 10.7974 10.2355C11.1477 10.2295 11.1484 9.68487 10.7974 9.69092L10.7981 9.69025Z" fill="#D6D9FC" />
                                    ...
                                    <defs>
                                      <linearGradient id="connect-dashboard-graphic-daybreak-yoga-logo-gradient" x1="8" y1="-1.21943e-07" x2="12.0917" y2="21.3592" gradientUnits="userSpaceOnUse">
                                        <stop stopColor="#938DFF" />
                                        <stop offset="1" stopColor="#533AFD" />
                                      </linearGradient>
                                    </defs>
                                ...
                                <div className="connect-platform-graphic__dashboard-table-amount connect-platform-graphic__dashboard-table-amount--daybreak-yoga tabular-nums--tight" style={{fontWeight: "var(--hds-font-weight-normal)", color: "var(--hds-color-core-neutral-600)"}}>
                                  {"$1,502.00"}
                                </div>
                                <div className="connect-platform-graphic__dashboard-table-amount connect-platform-graphic__dashboard-table-amount--daybreak-yoga tabular-nums--tight" style={{fontWeight: "var(--hds-font-weight-normal)", color: "var(--hds-color-core-neutral-600)"}}>
                                  {"$7,880.00"}
                              ...
                              <div className="connect-platform-graphic__dashboard-table-row connect-platform-graphic__dashboard-table-row--jackson-hot-yoga" style={{opacity: "1"}}>
                                <div className="connect-platform-graphic__dashboard-table-row-bg" style={{opacity: "0"}}>
                                </div>
                                <div className="connect-platform-graphic__dashboard-table-account-column">
                                  <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="8.87866" cy="8.16846" r="8" fill="#FF6118" />
                                    <path d="M6.91132 11.7767V10.5398C7.28025 10.6049 7.44301 10.6266 7.77939 10.6266C8.6149 10.6266 9.03808 10.3336 9.03808 9.46553V3.99673H10.427V9.57404C10.427 11.1257 9.52636 11.8636 7.94215 11.8636C7.56237 11.8636 7.28025 11.8419 6.91132 11.7767Z" fill="white" />
                                  </svg>
                                  {"Jackson Hot Yoga"}
                                </div>
                                <div>
                              ...
                              <div className="connect-platform-graphic__dashboard-table-row" style={{opacity: "1"}}>
                                <div className="connect-platform-graphic__dashboard-table-account-column">
                                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <rect width="16" height="16" rx="8" fill="url(#connect-dashboard-graphic-harmony-flow-logo-gradient)" />
                                    <defs>
                                      <linearGradient id="connect-dashboard-graphic-harmony-flow-logo-gradient" x1="16" y1="5.33309" x2="6.67512e-09" y2="10.6669" gradientUnits="userSpaceOnUse">
                                        <stop offset="0.355769" stopColor="#F6B080" />
                                        <stop offset="0.634615" stopColor="#D67EF9" />
                                        <stop offset="1" stopColor="#D67EF9" />
                                      </linearGradient>
                                    </defs>
                                  </svg>
                                  {"Harmony Flow"}
                              ...
                              <div className="connect-platform-graphic__dashboard-table-row" style={{opacity: "1"}}>
                                <div className="connect-platform-graphic__dashboard-table-account-column">
                                  <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="8.87766" cy="8.27393" r="8" fill="#FF6118" />
                                    <path d="M12.13 11.3724V12.5876H6.05355V11.5134L10.3288 6.01207H6.09695V4.79678H12.0866V5.87101L7.82223 11.3724H12.13Z" fill="white" />
                                  </svg>
                                  {"Zenith Zen"}
                                </div>
                                <div>
                              ...
                              <div className="connect-platform-graphic__dashboard-table-row" style={{opacity: "1"}}>
                                <div className="connect-platform-graphic__dashboard-table-account-column">
                                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8Z" fill="#FAB000" />
                                    <path d="M16 8C16 12.4183 12.4183 16 8 16C3.58172 16 0 12.4183 0 8C0 3.58172 3.58172 0 8 0C12.4183 0 16 3.58172 16 8Z" fill="#FAB000" />
                                    <path d="M8.74929 12H7.62081L5.58086 5.97782V12H4.28962V4.20914H6.19936L8.20675 10.1771L10.2141 4.20914H12.0805V12H10.7892V5.97782L8.74929 12Z" fill="white" />
                                  </svg>
                                  {"M.E. Yoga"}
                                </div>
                                <div>
                    ...
                    <div className="connect-platform-graphic__connection">
                      <svg width="131" height="95" viewBox="0 0 131 95" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <mask id="connect-platform-graphic-connection-mask">
                          <path d="M1.00002 95 L1 9.45337 C1 4.7847 4.7847 1 9.45337 1 L131 1.00001" stroke="white" strokeWidth="0.8025" strokeDasharray="222" strokeDashoffset="150" className="connect-platform-graphic__connection-mask" />
                        </mask>
                        <path d="M1.00002 95 L1 9.45337 C1 4.7847 4.7847 1 9.45337 1 L131 1.00001" stroke="url(#connect-platform-graphic-connection-gradient)" strokeWidth="0.8025" strokeDasharray="1.07 1.07" mask="url(#connect-platform-graphic-connection-mask)" />
                        <defs>
                          <linearGradient id="connect-platform-graphic-connection-gradient" x1="4.77907" y1="-0.76242" x2="4.67673" y2="45.7761" gradientUnits="userSpaceOnUse">
                            <stop stopColor="#EA2261" />
                            <stop offset="1" stopColor="#FAB7CC" />
                          </linearGradient>
                        </defs>
                      </svg>
                      <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg" className="connect-platform-graphic__connection-ring" style={{transform: "scale(0)"}}>
                        <circle cx="4.14003" cy="4.14" r="2.14" transform="rotate(90 4.14003 4.14)" fill="white" />
                        <circle cx="4.14003" cy="4.14" r="3.07625" transform="rotate(90 4.14003 4.14)" stroke="#EA2261" strokeOpacity="0.3" strokeWidth="1.8725" />
                        <circle cx="4.14003" cy="4.14" r="1.73875" transform="rotate(90 4.14003 4.14)" fill="white" stroke="#EA2261" strokeWidth="0.8025" />
                      </svg>
                      <div className="connect-platform-graphic__connection-amount-pill-container" style={{"--translate-x": "-40px", "--translate-y": "70px"}}>
                        <div className="connect-platform-graphic__connection-amount-pill" style={{opacity: "1", transform: "scale(1)"}}>
                          {"$999.00"}
                        </div>
                      </div>
                    </div>
        ...
        <div className="modular-solutions-bento-card__background">
          <div className="connect-graphic__background">
            <picture className="connect-graphic__background-image">
              <source type="image/webp" srcSet="/stripe/connect-bento-card-background-image-w1232-0789340a.webp 1x, /stripe/connect-bento-card-background-image-w2464-130d999b.webp 2x" />
              <img loading="lazy" width="2464" height="900" alt="" srcSet="/stripe/connect-bento-card-background-image-w1232-7e3035f4.jpg 1x, /stripe/connect-bento-card-background-image-w2464-e60db76b.jpg 2x" src="/stripe/connect-bento-card-background-image-w1232-7e3035f4.jpg" />
            </picture>
            <picture className="connect-graphic__background-image-mobile">
              <source type="image/webp" srcSet="/stripe/ConnectMobileBackground-w296-d94fcdf7.webp 296w, /stripe/ConnectMobileBackground-w396-5f5bc214.webp 396w, /stripe/ConnectMobileBackground-w608-8ad4d33c.webp 608w, /stripe/ConnectMobileBackground-w816-72b54f77.webp 816w, /stripe/ConnectMobileBackground-w1104-a28fe1b6.webp 1104w" />
              <img loading="lazy" width="1104" height="1620" alt="" sizes="(min-width: 640px) calc(100vw - 64px), calc(100vw - 32px)" srcSet="/stripe/ConnectMobileBackground-w296-0b540537.jpg 296w, /stripe/ConnectMobileBackground-w396-64ae4ba1.jpg 396w, /stripe/ConnectMobileBackground-w608-b5c332a5.jpg 608w, /stripe/ConnectMobileBackground-w816-7e3ff278.jpg 816w, /stripe/ConnectMobileBackground-w1104-11dc789b.jpg 1104w" src="/stripe/ConnectMobileBackground-w296-0b540537.jpg" />
            </picture>
          </div>
        </div>
      </div>
